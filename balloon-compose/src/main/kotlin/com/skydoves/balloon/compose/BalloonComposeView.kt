...
internal class BalloonComposeView(
  ...
  override suspend fun awaitAlignEnd(
    xOff: Int,
    yOff: Int,
  ) = balloon.awaitAlignEnd(anchorView, xOff, yOff)

  override suspend fun awaitAlignStart(
    xOff: Int,
    yOff: Int,
  ) = balloon.awaitAlignStart(anchorView, xOff, yOff)
